          ...
          {clients.map((client) => (
              ...
              >
                  <div className="flex justify-between items-center">
                      ...
                      <span className={`px-1.5 py-0.5 rounded-md text-[7px] font-black uppercase tracking-wider border backdrop-blur-md ${client.is_active ? 'bg-green-500/10 text-green-400 border-green-500/20' : 'bg-gray-500/10 text-gray-400 border-gray-500/20'}`}>
            ...
            <div className="flex items-center gap-3 p-3 bg-white/5 rounded-[20px] border border-white/10 relative overflow-hidden group">
              ...
              <div className="z-10 min-w-0">
                ...
                <div className="flex items-center gap-2 mt-1">
                  <span className={`px-1 py-0.5 rounded-md text-[6px] font-black uppercase tracking-[0.2em] border ${activeClient.is_active ? 'bg-green-500/10 text-green-400 border-green-500/20' : 'bg-gray-500/10 text-gray-400 border-gray-500/20'}`}>
                    {activeClient.is_active ? 'Aktivan' : 'Neaktivan'}
                  </span>
                </div>
              </div>
            </div>
