...
<body>
    <div class="page">
            ...
            <div class="header-inner">
                ...
                <div class="header-right">
                    ...
                    <div class="invoice-meta">
                        <div><strong>Datum:</strong> {{ $quote->date->format('d.m.Y') }}</div>
                        @if($quote->valid_until)
                        <div><strong>Važi do:</strong> {{ $quote->valid_until->format('d.m.Y') }}</div>
                        @endif
                    </div>
                </div>
            </div>
        ...
        <div class="two-col">
            <div class="col">
                ...
                @if($quote->client?->city || $quote->client?->zip)
                    <div class="company-meta">{{ $quote->client->zip }} {{ $quote->client->city }}@if($quote->client?->country), {{ $quote->client->country }}@endif</div>
                @endif
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        ...
                        @if($item->description)<br><span style="font-size: 9pt; color: #6b7280;">{!! nl2br(e($item->description)) !!}</span>@endif
                    </td>
        ...
        @if($quote->notes)
        <div class="notes">
            <strong>Napomena:</strong><br>{!! nl2br(e($quote->notes)) !!}
        </div>
        @endif
    </div>
</body>
