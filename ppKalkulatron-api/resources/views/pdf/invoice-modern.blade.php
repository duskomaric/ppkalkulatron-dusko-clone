...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .fiscal { margin-top: 20px; padding: 14px; background: #ecfdf5; border-radius: 8px; border-left: 4px solid #10b981; font-size: 9pt; color: #047857; }
        .fiscal a { color: #059669; font-weight: bold; }
    </style>
</head>
<body>
    <div class="page">
            ...
            <div class="header-inner">
                ...
                <div class="header-right">
                    ...
                    <div class="invoice-meta">
                        <div>Datum: {{ $invoice->date->format('d.m.Y') }}</div>
                        <div>Dospijeće: {{ $invoice->due_date->format('d.m.Y') }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col">
                <div class="card">
                    ...
                    @if($invoice->client?->city || $invoice->client?->zip)
                        <div class="company-meta">{{ $invoice->client->zip }} {{ $invoice->client->city }}
