...
<body>
    <div class="page">
        ...
        <div class="client-block">
            ...
            @if($quote->client?->address)<div class="meta">{{ $quote->client->address }}</div>@endif
            @if($quote->client?->city || $quote->client?->zip)
                <div class="meta">{{ $quote->client->zip }} {{ $quote->client->city }}@if($quote->client?->country), {{ $quote->client->country }}@endif</div>
            @endif
            @if($quote->client?->email)<div class="meta">{{ $quote->client->email }}</div>@endif
        </div>
        ...
        <div class="totals">
            <table>
                <tr><td class="meta">Osnovica</td><td class="text-right">{{ $formatAmount($quote->subtotal) }} {{ $currency }}</td></tr>
                <tr><td class="meta">PDV</td><td class="text-right">{{ $formatAmount($quote->tax_total) }} {{ $currency }}</td></tr>
                <tr><td class="grand-total">Ukupno</td><td class="text-right grand-total">{{ $formatAmount($quote->total) }} {{ $currency }}</td></tr>
            </table>
        </div>
