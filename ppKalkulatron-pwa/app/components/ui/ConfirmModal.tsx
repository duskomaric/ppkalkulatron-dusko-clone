...
export function ConfirmModal({
  ...
  return (
    <ModalShell
      isOpen={isOpen}
      onClose={onClose}
      backdropClassName="bg-black/60 backdrop-blur-[12px] animate-fade-in transition-all duration-500"
      contentClassName="w-full max-w-[340px] bg-[#0F0F13]/95 backdrop-blur-2xl border border-white/10 rounded-[40px] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.5)] overflow-hidden animate-slide-in-bottom"
    >
      {/* Glow Effects */}
